...
- (void)setupButtons {
    ...
    UIImage *smallLongArrowIcon = self.isRTL ? [BPKIcon templateIconNamed:BPKIconNameArrowLeftSm]
                                             : [BPKIcon templateIconNamed:BPKIconNameArrowRightSm];
    ...
    UIImage *largeLongArrowIcon = [BPKIcon templateIconNamed:BPKIconNameArrowRightLg];
