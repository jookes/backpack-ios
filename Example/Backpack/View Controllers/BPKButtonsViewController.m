...
- (void)setupButtons {
    ...
    UIImage *smallLongArrowIcon = self.isRTL ? [BPKIcon templateIconNamed:BPKIconNameLongArrowLeftSm]
                                             : [BPKIcon templateIconNamed:BPKIconNameLongArrowRightSm];
    ...
    UIImage *largeLongArrowIcon = [BPKIcon templateIconNamed:BPKIconNameLongArrowRightLg];
